...
- (NSObject<HTTPResponse> *)httpResponseForMethod:(NSString *)method URI:(NSString *)path
{
    ...
    } else if ([method isEqualToString:@"GET"] && [path isEqualToString:@"/getPasteboardString"]) {
        NSString *pasteStr = [[NSPasteboard generalPasteboard] stringForType:NSPasteboardTypeString];
        
        return [[HTTPDataResponse alloc] initWithData:[pasteStr dataUsingEncoding:NSUTF8StringEncoding]];
    }
